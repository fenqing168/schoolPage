    ...
    var o = function () {
        ...
        return o(t, [{
                    ...
                    return regeneratorRuntime.wrap(function (t) {
                        ...
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
                                ...
                                }, r.email || this.errMsg("请输入邮箱"), r.password || this.errMsg("请输入密码"), r.captcha_v || this.errMsg("请输入验证码"), t.next = 7, this.ajax(n, r, function (data) {
                                    if(data.code === 0){
                                        layer.alert('注册成功，等登录。',{icon:6, end:function () {
                                                $('[href="#signin-form"]').click();
                                            }});
                                    }else{
                                        oThis.errMsg(data.msg);
                                    }
                                }, function (data) {
                                });
                            case 7:
            ...
            key: "ajax", value: function () {
                ...
                var n = e(regeneratorRuntime.mark(function t(n, r, f, e) {
                    var e;
                    return regeneratorRuntime.wrap(function (t) {
                        for (; ;) switch (t.prev = t.next) {
                            case 0:
